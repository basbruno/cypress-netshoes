...
it('pesquisarCamisetaEBrasilEAdicionarSegundoItem&ConcluirCompra', () => {
    
    Compra.selecionarProdutoedicionarAoCarrinho1()


    Compra.selecionarMaisUmProduto()

    Compra.selecionarProdutoedicionarAoCarrinhoEFinliza()
